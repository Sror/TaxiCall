#ifndef _mysql_client_conn_h
#define _mysql_client_conn_h
...
#include "mysql_client_private.h"
...
//
    ...
    public:
        ...
        CMysqlSet(MYSQL_RES* res)
            :m_ptr(res, mysql_private::CloseResultSet), m_rowCount(0), m_nFields(0)
        {
            if (m_ptr)
            {
...
//
    ...
    public:
                        ...
                        string const& password)
        {
            ...
            try
            {
                m_ptr = mysql_private::GetConnection(hostName, dbName, username, password);
            }
        ...
        {return mysql_private::GetLastErrorCode(m_ptr);}
        
        string GetLastErrorString() const
        {return mysql_private::GetLastErrorString(m_ptr);}
